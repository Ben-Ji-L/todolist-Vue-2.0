<template>
  <section class="todoapp">
      ...
      <div class="main">
          ...
          <ul class="todo-list">
              <li class="todo" v-for="todo in filteresTodos" :class="{completed: todo.completed, editing: todo === editing}">
                  <div class="view">
      ...
      <footer class="footer" v-show="hasTodos">
          ...
          <ul class="filters">
              <li><a href="#" :class="{selected: filter === 'all'}" @click.prevent="filter = 'all'">Toutes les tâche</a></li>
              <li><a href="#" :class="{selected: filter === 'todo'}" @click.prevent="filter = 'todo'">a faire</a></li>
              <li><a href="#" :class="{selected: filter === 'done'}" @click.prevent="filter = 'done'">Faites</a></li>
          </ul>
          <button class="clear-completed" v-show="completed" @click.prevent="deleteCompleted">Supr les tâches finies</button>
      </footer>
  </section>
</template>
